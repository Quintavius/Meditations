...
namespace Dreamteck.Splines
{
    ...
    public class InitWindow : EditorWindow
    {
        ...
        void Home()
        {
            ...
            homePanel.Begin();
            if(MenuButton(new Vector2(25, 25), changelogIcon, "What's new?", "See all new features, important changes and bugfixes in " + PluginInfo.version))
            {
        ...
        void Support()
        {
            if (supportPanel == null || !supportPanel.isActive) return;
            supportPanel.Begin();
        ...
        void Learn()
        {
            if (learnPanel == null || !learnPanel.isActive) return;
            learnPanel.Begin();
