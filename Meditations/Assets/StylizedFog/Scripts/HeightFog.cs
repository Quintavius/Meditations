...
public sealed class HeightFog : PostProcessEffectSettings
{
	...
	[Min(0.0f), Tooltip("The starting distance of the height fog")]
	...
	[Min(0.1f), Tooltip("Noise texture scale for the fog"), DisplayName("Noise scale")]
...
public class HeightFogRenderer : PostProcessEffectRenderer<HeightFog>
{
	...
	{
		var shader = Shader.Find("Hidden/Custom/HeightFog");
